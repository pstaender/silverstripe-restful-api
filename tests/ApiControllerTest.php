...
class ApiControllerTest extends SapphireTest
{
  ...
  public static function request($method, $url, $data = null, $accessToken = null)
  {
      $body = null;
      if (is_array($data)) {
    ...
    public static function extract_code_and_data_from_response($resp, $expectJSON = true)
    {
    ...
    public static function send_test($method, $url, $data = null, $accessToken = null, $expectJSON = true)
    {
        return self::extract_code_and_data_from_response(self::request($method, $url, $data, $accessToken), $expectJSON);
    }

    public static function ensure_correct_config($testSuite)
    {
        $expectedConfig = [
      "ApiController" => [
